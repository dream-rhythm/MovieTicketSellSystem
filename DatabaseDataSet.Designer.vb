...
Partial Public Class DatabaseDataSet
    ...
    Partial Public Class accountDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Overloads Function AddaccountRow(ByVal account As String, ByVal password As String, ByVal username As String, ByVal picture() As Byte) As accountRow
            Dim rowaccountRow As accountRow = CType(Me.NewRow,accountRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, account, password, username, picture}
    ...
    Partial Public Class accountRow
        ...
        Public Property account() As String
            Get
                Try 
                    Return CType(Me(Me.tableaccount.accountColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("資料表 'account' 中資料行 'account' 的值是 DBNull。", e)
                End Try
            End Get
            Set
                Me(Me.tableaccount.accountColumn) = value
            End Set
        End Property
        ...
        Public Property picture() As Byte()
            Get
                Try 
                    Return CType(Me(Me.tableaccount.pictureColumn),Byte())
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("資料表 'account' 中資料行 'picture' 的值是 DBNull。", e)
                End Try
            End Get
            Set
                Me(Me.tableaccount.pictureColumn) = value
            End Set
        End Property
        ...
        Public Function IsaccountNull() As Boolean
            Return Me.IsNull(Me.tableaccount.accountColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetaccountNull()
            Me(Me.tableaccount.accountColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function IspictureNull() As Boolean
            Return Me.IsNull(Me.tableaccount.pictureColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")>  _
        Public Sub SetpictureNull()
            Me(Me.tableaccount.pictureColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace DatabaseDataSetTableAdapters
    ...
    Partial Public Class accountTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `account` WHERE ((`id` = ?) AND ((? = 1 AND `account` IS NULL) OR (`a"& _ 
                "ccount` = ?)) AND ((? = 1 AND `password` IS NULL) OR (`password` = ?)) AND ((? ="& _ 
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `account` (`account`, `password`, `username`, `picture`) VALUES (?, ?"& _ 
                ", ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `account` SET `account` = ?, `password` = ?, `username` = ?, `picture` = ?"& _ 
                " WHERE ((`id` = ?) AND ((? = 1 AND `account` IS NULL) OR (`account` = ?)) AND (("& _ 
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.FinalProject.My.MySettings.Default.DatabaseConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT id, account, [password], username, picture FROM account"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_id As Integer, ByVal Original_account As String, ByVal Original_password As String, ByVal Original_username As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal account As String, ByVal password As String, ByVal username As String, ByVal picture() As Byte) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal account As String, ByVal password As String, ByVal username As String, ByVal picture() As Byte, ByVal Original_id As Integer, ByVal Original_account As String, ByVal Original_password As String, ByVal Original_username As String) As Integer
            If (account Is Nothing) Then
